...
const ALL_BUILDS = [
  ...
  { entryPath: './plugins/beta/datasets/src/adapters/maplibre/index.umd.js', libraryPath: 'datasetsMaplibreAdapter', outDir: 'plugins/beta/datasets/adapters/maplibre/dist/umd' },
