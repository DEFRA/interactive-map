...
describe('LayersMenuCheckbox', () => {
  describe('when the dataset is not in the registry', () => {
    it('returns null', () => {
      ...
      const { container } = render(<LayersMenuCheckbox menuGroupItem={menuGroupItem} onChange={onChange} dispatch={dispatch} />)
  ...
  describe('when the dataset exists', () => {
    ...
    it('renders the dataset label', () => {
      datasetRegistry.getDataset.mockReturnValue(baseDataset)
      render(<LayersMenuCheckbox menuGroupItem={menuGroupItem} onChange={onChange} dispatch={dispatch} />)
