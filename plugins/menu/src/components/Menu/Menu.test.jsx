...
jest.mock('./CheckboxGroupWrapper.jsx', () => ({
  CheckboxGroupWrapper: ({ menuGroup, children }) => (
...
describe('Menu', () => {
  ...
  describe('checkbox groups', () => {
    it('renders a CheckboxGroupWrapper for each checkbox group', () => {
      const pluginState = makePluginState([
    ...
    it('passes the correct group to CheckboxGroupWrapper', () => {
  ...
  describe('radio groups', () => {
    ...
    it('does not render a CheckboxGroupWrapper for radio groups', () => {
