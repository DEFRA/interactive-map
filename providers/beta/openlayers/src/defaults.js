...
// ESRI TileInfo LOD resolutions for EPSG:27700. When used in the OL View, view.zoom
// matches ESRI SDK zoom levels exactly. OL maps between view resolution and the nearest
// OS tile grid level automatically when loading tiles.
export const ESRI_LOD_RESOLUTIONS = [
...
export const ESRI_DEFAULT_MIN_ZOOM = 6
...
export const ESRI_DEFAULT_MAX_ZOOM = 20
