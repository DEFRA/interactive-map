...
Use the interact plugin to let users click a building on the map background and see its properties in a panel. Selecting another building replaces the current selection; clicking outside clears it.
